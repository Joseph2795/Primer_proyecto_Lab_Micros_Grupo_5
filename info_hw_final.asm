...
cons_info db '                       Instituto Tecnologico de Costa Rica',13,10 ; 13 es un 'enter' 10 un espacio
		 ...
		 db '5. Ver Cores y Threads',13,10
                 db '6. Ver info de disco duro',13,10
...
_MSJS:
		...
		impr_texto  cons_info,   cons_tamano_info
		
		;Imprimir el requerimiento
		impr_texto  cons_banner,   cons_tamano_banner
...
_MSJS2:
		impr_texto  cons_info2,   cons_tamano_info2
		
		;Imprimir el requerimiento
		impr_texto  cons_banner,   cons_tamano_banner			;Llamar al sistema	
		jmp _LIBERAR2
...
_LIBERAR2: ; Utilizada para limpiar variables del sub menú
		mov r10,0x00000000
		mov [variable],r10
		mov rdx,r10
		mov rsi,r10
